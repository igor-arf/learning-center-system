...
class BranchViewSet(viewsets.ModelViewSet):
    ...
    def statistics(self, request, pk=None):
        ...
        stats = {
            ...
            "students_total": sum(
                ...
                for group in branch.groups.filter(is_active=True)
            ),
    ...
    def _calculate_branch_utilization(self, branch):
        ...
        total_slots = (
            branch.classrooms_count * 8 * 7
        )  # кабинеты * часы в день * дни в неделю
...
class TeacherViewSet(viewsets.ModelViewSet):
    ...
    def schedule(self, request, pk=None):
        ...
        schedule_data = {
            ...
            "estimated_income": self._calculate_estimated_income(
                teacher, lessons, compensation_work
            ),
        }
        ...
        try:
            ...
            compensation = CompensationWork.objects.create(
                ...
                total_payment=self._calculate_compensation_payment(
                    duration, teacher.compensation_rate
                ),
            )
    ...
    def _calculate_total_hours(self, lessons, compensation_work):
        ...
        comp_hours = sum(
            work.duration.total_seconds() / 3600 for work in compensation_work
        )
...
class GroupViewSet(viewsets.ModelViewSet):
    ...
    def progress_report(self, request, pk=None):
        ...
        avg_attendance = (
            group.lessons.filter(status="completed").aggregate(
        ...
        report_data = {
            ...
            "attendance": {
                ...
                "attendance_rate": (
                    round((avg_attendance / group.current_students_count) * 100, 1)
...
class ScheduleViewSet(viewsets.ViewSet):
            ...
            calendar_data.append(
                {
                    ...
                    "teacher": {
                        ...
                        "name": lesson.teacher.user.get_full_name()
                ...
                return Response(
                    {
                        ...
                        "generated_lessons_count": len(result["regular_lessons"])
                        + len(result["special_lessons"]),
                    }
                )
            else:
                return Response(
    ...
    def conflicts(self, request):
        ...
        lessons = Lesson.objects.select_related("group", "teacher", "classroom").filter(
            datetime__date__gte=start_date,
            datetime__date__lte=end_date,
            status="scheduled",
        )
